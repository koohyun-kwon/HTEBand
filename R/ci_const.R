...
#' Confidence interval for regression function value for Hölder space: Modified
#'
#' Constructs a confidence interval for regression function value for Hölder space based on
#' the optimal one-sided procedure of Armstrong and Kolesár (2020).
#'
...
#' x <- stats::runif(500, min = -1, max = 1)
#' y <- x + rnorm(500, 0, 1/4)
#' ci_reg_Hol2(y, x, 1/2, 1, 0.99)
ci_reg_Hol2 <- function(y, x, point, C, level, kern = "triangular", se.initial = "EHW", se.method = "nn", J = 3){
